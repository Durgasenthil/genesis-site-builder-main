      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-sage-light to-mint flex items-center justify-center shadow-lg">
              <div className="text-center p-8">
                <Leaf className="h-20 w-20 text-primary mx-auto mb-4" />
                <p className="text-primary font-medium">Healing with Nature</p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {badges.map(({ key, icon: Icon }) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-foreground">{t(`about.badge.${key}`)}</span>
                </div>
              ))}
            </div>
          </motion.div>
